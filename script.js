...
function linkVisited(clicked_id) {
  document.getElementById(clicked_id).innerHTML="<p style='text-decoration: none; color: fuchsia; font-size: 1.01vw; font-style: italic; font-weight: lighter;'>You have visited this link</p>"
}
